...
class GoodsCategory(models.Model):
    ...
    parent_category = models.ForeignKey('self',null=True, blank=True, verbose_name='父类别',on_delete=models.CASCADE, related_name='sub_cat', help_text='父目录')
...
class Goods(models.Model):
    ...
    goods_num = models.IntegerField(default=0, verbose_name='库存书')
    market_price = models.FloatField(default=0, verbose_name='市场价格')
    shop_price = models.FloatField(default=0, verbose_name='本店价格')
    goods_brief = models.TextField(max_length=500, verbose_name='商品简短描述')
    goods_desc = UEditorField(verbose_name=u'内容', imagePath='goods/images/', filePath='goods/filter',
    ...
    #goods_front_image_url = models.ImageField(upload_to='', default='', verbose_name='封面图')
