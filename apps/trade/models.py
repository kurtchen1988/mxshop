...
class OrderInfo(models.Model):
    ...
    order_sn = models.CharField(max_length=30,unique=True, blank=True, verbose_name='订单号')
    #nonce_str = models.CharField(max_length=50, null=True, blank=True, verbose_name='')
    trade_no = models.CharField(max_length=50, unique=True, null=True, blank=True, verbose_name=u'')
